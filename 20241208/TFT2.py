...
# Zaman indeksleme ve grup tanımı
...
# Early stopping ve checkpoint callback'leri
...
plt.title("TFT - Tahmin vs. Gerçek (Decoder Dönemi)")
...
# Encoder + Decoder birleşmiş grafik
...
full_pred = np.concatenate([encoder_input, decoder_pred])
