...
actual = series[-10:].values  # son 10 ayın gerçek değerleri

# Tahmin edilen değerler (zaten tam sayı)
predicted = hybrid_forecast
...
plt.title('ARIMA + LSTM Hibrit Tahmin (10 Aylık)')
plt.xlabel("Tarih")
plt.ylabel("Sayı")
plt.legend()
plt.grid(True)
